package ch.megard.pekko.http.cors.javadsl.settings
...
import ch.megard.pekko.http.cors.javadsl.model.{HttpHeaderRange, HttpOriginMatcher}
import ch.megard.pekko.http.cors.scaladsl
import ch.megard.pekko.http.cors.scaladsl.settings.CorsSettingsImpl
